...
2. The average alter effect on behavior.
...
myeff3 <- includeEffects(myeff3, avAlt, name = "freq_run", interaction1 = "kudonet") 
myeff3 <- includeEffects(myeff3, avAlt, name = "time_run", interaction1 = "kudonet")
...
### Club 1
```{r, echo=F}
htmltools::includeHTML("files/clubs results/28-4/club 1.html")
```

### Club 2
```{r, echo=F}
htmltools::includeHTML("files/clubs results/28-4/club 2.html")
```
...
### Club 4
```{r, echo=F}
htmltools::includeHTML("files/clubs results/28-4/club 4.html")
```
...
### Club 5
```{r, echo=F}
htmltools::includeHTML("files/clubs results/28-4/club 5.html")
```
