...
Below, we will follow these steps for club 1 (N=30). We will explore the SAOM for 3 clubs in order to find the best model (see [Results](#result)). We will subsequently test if this model also fits the data of the remaining two clubs.
...
myeff1 <- includeEffects(myeff, outActSqrt, inPopSqrt, name = "kudonet") 
```
