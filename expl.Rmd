...
1. The indegreedegree effect on behavior.
...
2. The average (out-) alter effect.
This test the social comparison explanation: the tendency to assimilate to the average behavior of alters
