...
Here we present the results for club 1 (N=30), club 2 (N=63), and club 5 (N=77).
...
We see a marginal reciprocated degree effect on running volume (club 1) and running frequency (club 2), but not in club 5. In club 5 we find a significant and positive parameter estimate for the average reciprocated degree effect on behavior. 
