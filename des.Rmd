...
<!--- #JT see how I fixed the printing. use directory names en name the specific files ---> 
...
#RF For some reason the ggplot plots do not show up on the github page......

---> 

### Club 1
```{r testplaatjes, results='hold'}
df <- clubdata_rsiena[[1]] # grab club 
df2 <- clubdata[[1]]
