...
Clean the working environment and load in the club and ego data.
...
netsize <- c( 
  ...
  length(clubdata_rsiena[[5]]$nodeSets$Actors)) 
...
hist(df$depvars$time_run, main = "Histogram of Running Volume", xlab = "Hours per week", ylab = "count", col = "grey", border= "black", breaks = (max(df2$time_run)-min(df2$time_run)+1))
