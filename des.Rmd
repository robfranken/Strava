...
- fMoran.i: calculate Moran's I spatial autocorrelation (see [here](https://www.jochemtolsma.nl/courses/complete-networks/socio7/#morans-autocorrelation-for-outgoing-ties-rsiena-build-in-dataset))
...
## 2. Other activities (e.g., cycling and swimming) {.tabset .tabset-fade}

We will describe other activities as well.
...
# Behavioral similarity in networks
