...
```{r, echo=FALSE, fig.cap="dyadic similarity (RSiena manual, p28)"}
...
```{r, echo=FALSE, fig.cap="avSim (RSiena manual, p174)"}
...
```{r, echo=FALSE, fig.cap="avAttHigher (RSiena manual, p176)"}
...
```{r, echo=FALSE, fig.cap="avAttLower (RSiena manual, p176)"}
...
```{r, echo=FALSE, fig.cap="avAlt (RSiena manual, p177)"}
