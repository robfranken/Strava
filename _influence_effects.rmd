...
```{r}
finluenceplot2 <- function(alters, min, max, fun) {
  s <- NA
  for (i in min:max) {
    s[i] <- 0
...
finluenceplot(alters=alters1, min=1, max=6, favSim2)
finluenceplot(alters=alters1, min=1, max=6, favAlt)
finluenceplot(alters=alters1, min=1, max=6, fAttMean)
finluenceplot(alters=alters1, min=1, max=6, favAttHigher)
finluenceplot(alters=alters1, min=1, max=6, favAttLower)
finluenceplot2(alters=alters1, min=1, max=6, list(favAttLower, favAttHigher))
finluenceplot2(alters=alters1, min=1, max=6, list(fAttMean, favAttHigher))
```
