...
finluenceplot2(alters=alters1, min=1, max=6, list(favSim), params=c(1))
finluenceplot2(alters=alters1, min=1, max=6, list(favAlt), params=c(1))
finluenceplot2(alters=alters1, min=1, max=6, list(fAttMean), params=c(1))
finluenceplot2(alters=alters1, min=1, max=6, list(favAttHigher), params=c(1))
finluenceplot2(alters=alters1, min=1, max=6, list(favAttLower), params=c(1))
finluenceplot2(alters=alters1, min=1, max=6, fun=list(favAttLower, favAttHigher), params=c(1,1))
finluenceplot2(alters=alters1, min=1, max=6, list(fAttMean, favAttHigher), params=c(1,1))
