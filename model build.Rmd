...
Because we are now modeling the evolution of both the network and the attribute (running behavior), we will add an additional indicator to evaluate GOF; namely, does the model capture the distribution of actors’ attribute levels over time?
