...
We make, for each club, 5 model specifications: 
...
myeff <- getEffects(clubdata_rsiena[[2]])
...
## Club 3
```{r echo=T, results='hide'}
myeff <- getEffects(clubdata_rsiena[[3]])
...
## Club 4
```{r echo=T, results='hide'}
myeff <- getEffects(clubdata_rsiena[[4]])
...
## Club 5
```{r echo=T, results='hide'}
myeff <- getEffects(clubdata_rsiena[[5]])
