...
# gender effects fixed-and-tested
myeff3 <- setEffect(myeff3, effFrom, name = "freq_run", interaction1 = "gender", fix=T, test = T, initialValue = 0)
myeff3 <- setEffect(myeff3, effFrom, name = "time_run", interaction1 = "gender", fix=T, test = T, initialValue = 0)
# same for 'other sports'
myeff3 <- setEffect(myeff3, effFrom, name = "time_run", interaction1 = "time_other", fix=T, test=T, initialValue=0)
myeff3 <- setEffect(myeff3, effFrom, name = "freq_run", interaction1 = "freq_other", fix=T, test=T, initialValue=0)
...
# outdegree effect (fixed-and-tested)
myeff4 <- setEffect(myeff4, outdeg, name = "freq_run", interaction1 = "kudonet", fix=T, test=T, initialValue=0)
myeff4 <- setEffect(myeff4, outdeg, name = "time_run", interaction1 = "kudonet", fix=T, test=T, initialValue=0)
```
...
## Estimate model with indegree effect (M2)
try <- 1
