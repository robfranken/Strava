...
Outdegree GOF is bad (p=0). MHD is the predicted Mahalanobis distance in the extended model (including the particular effect). We see that the Outdegree-distribution would improve drastically if we include the interaction between reciprocity and transitivity (GWESP).
