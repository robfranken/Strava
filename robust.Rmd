...
Again, only a slight change in network stability. But overall, the average degree has decreased to a greater extent. Let's use this as our operationalization, and let's investigate how this impacts our findings. We use the same model as we did in our main analyses. Below are the results:
...
```{r, echo=F}
htmltools::includeHTML("files/robustness/3kudoModel.html")
```
