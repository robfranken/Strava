...
for (i in 1:5) { # for each club
  ...
  tab[14, i] <- paste(as.character(round(mean(clubdata[[i]]$freq_run[,,1]), 3)), " (", as.character(round(sd(clubdata[[i]]$freq_run[,,1]), 3)), ")", sep="")
  tab[15, i] <- paste(as.character(round(mean(clubdata[[i]]$time_run[,,1]), 3)), " (", as.character(round(sd(clubdata[[i]]$time_run[,,1]), 3)), ")", sep="")
}
# male sex (%)
for (i in 1:5) { # for each club
  # percentage male
