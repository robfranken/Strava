...
for (i in (1: length(club_str))) {
  ...
  club <- list(friendship = friend_data, kudo = kudo_data, 
...
for (i in 1:5) { 
  ...
  mydata <- sienaDataCreate(kudonet, friendship, freq_run, time_other, freq_other, gender, winter)
  mydata2 <- sienaDataCreate(kudonet, friendship, time_run, time_other, freq_other, gender, winter)
