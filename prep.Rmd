...
for (i in 1:5) { 
  ...
  mydata <- sienaDataCreate(kudonet, freq_run, time_other, freq_other, gender, winter, joiners)
  mydata2 <- sienaDataCreate(kudonet, time_run, time_other, freq_other, gender, winter, joiners)
