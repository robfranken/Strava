...
{
  load("clubs/clubid1/club1.RData")
  club1 <- club
  
  club2 <- load("clubs/clubid2/club2.RData")
  club2 <- club
  
  club3 <- load("clubs/clubid3/club3.RData")
  club3 <- club
  
  club4 <- load("clubs/clubid4/club4.RData")
  club4 <- club
  
  club5 <- load("clubs/clubid5/club5.RData")
  club5 <- club
}
