...
* Our primary network variable is the Kudos-network. A tie i -> j exists if ego i award at least 1 Kudos to alter j. We may want to include the Kudos-netwerk as an ordered network variable, as described in @rsienamanual, section 5.6. We also include network variables where the cut-off value for a kudos tie to exist is 2 (knet2) and 3 (knet3)
