...

{
  ...
  # CLUB 1
  {
    ...
    
    {
      ...
      myeff <- setEffect(myeff, higher, name = "kudonet", interaction1 = "time_run")
  ...
  # CLUB 4
  {
    ...
    
    {
      ...
      myeff <- setEffect(myeff, Rate, name = "time_run", fix = TRUE, test = FALSE, type = "rate", period = 8, initialValue = 5) # fix rate.
    }
